...
You'll find here the FW 5.x (KT/PW/PW2/KT2/KV/PW3/KOA/KT3) port of the ScreenSavers : http://www.mobileread.com/forums/showthread.php?t=88004 hack, along with a Python 2.7.10 package ;).
...
ScreenSavers v0.24.N (Minor bugfixes, updated binaries), Python v0.14.N (Updated binaries, Python 2.7.10).
...
Here are general *update* instructions for these hacks:
    ...
    * You simply have to apply the latest Update_*_install.bin updates, one by one.
...
You'll need to first install the Python package attached to this post (be aware that you'll need > 150MB of free space on your device for the install to proceed).
If you own a PW2 or a Kindle Basic, download the kindle-python-0.14.N-pw2_kt2_kv_pw3_koa_kt3.zip file, or if you own a Touch or a PW1, download the kindle-python-0.14.N-touch_pw1.zip file.
Once you have the right archive for your device, unpack it. In here, you'll find a few files.

First, upload the appropriate install .bin file for your device (*Update_python_0.14.N_install_pw2_kt2_kv_pw3_koa_kt3.bin* for a PW2 or a KT2 or a KV or a PW3 or a KOA or a KT3, the other one for a Touch or a PW1) to the root directory of your Kindle.

Now, eject & unplug your Kindle, and go to *[HOME] -> [MENU] > Settings -> [MENU] > Update Your Kindle*. It should take a couple of minutes.
...
*IMPORTANT*: Remember that *on FW >= 5.5.x*, using MRPI is _REQUIRED_ to install custom packages!



Download the attached kindle-linkss-0.24.N.zip file, and unpack it. In here, you'll find a few files.

First, upload the appropriate install .bin file for your device (*Update_linkss_0.24.N_install_pw2_kt2_kv_pw3_koa_kt3.bin* for a PW2 or a KT2 or a KV or a PW3 or a KOA or a KT3, the other one for a Touch or a PW1) to the root directory of your Kindle.
...
**Doc:* $Id: SS_MR_THREAD 13339 2016-07-08 21:13:56Z NiLuJe $
